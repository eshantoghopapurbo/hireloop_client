    ...
    return (
        <div className="w-full min-h-screen bg-zinc-950 text-zinc-50 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
                ...
                <div className=" container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-start mb-24">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="my-6 flex items-baseline gap-1">
                                    <span className="text-4xl font-black text-blue-500 tracking-tight">{plan.price}</span>
