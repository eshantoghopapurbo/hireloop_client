...
//     const handleSelectChange = (name, keyString) => {
//         setFormData(prev => ({ ...prev, [name]: keyString }));
//         if (errors[name]) {
//             setErrors(prev => ({ ...prev, [name]: null }));
//         }
//     };
...
//             companyName: autoFilledCompany.name,
//             status: 'active',
...
//             {/* ইমেজ স্টাইল গাইডের মতো মেইন থিম কন্টেইনার */}
...
//                         <span className="text-neutral-400">Posting as: <strong className="text-white">{autoFilledCompany.name}</strong></span>
//                     </div>
//                     <span className="text-xs bg-emerald-950 text-emerald-400 px-2 py-0.5 rounded border border-emerald-800/50">
//                         {autoFilledCompany.status}
//                     </span>
//                 </div>
...
//                             </div>
//                             {/* Job Category (তোমার দেওয়া v3 সিলেক্ট কোড গাইড অনুযায়ী) */}
//                             <div className="flex flex-col w-full relative">
...
//                                 const selectedKey = keys ? Array.from(keys)[0] : "";
//                                handleSelectChange("jobCategory", selectedKey);
//                                }}
//                                 >
...
//                                     onSelectionChange={(keys) => handleSelectChange('jobType', Array.from(keys)[0])}
//                                     className="w-full"
//                                 >
